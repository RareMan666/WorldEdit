...
public final class BlockData {
   ...
   public static int rotate90(int type, int data) {
      switch (type) {
         ...
         case 131:
            int extra2 = data & -4;
            int withoutFlags2 = data & 3;
            switch (withoutFlags2) {
               case 0:
                  return 1 | extra2;
               case 1:
                  return 2 | extra2;
      ...
      if (increment != -1 && increment != 1) {
         ...
         switch (type) {
            ...
            case 6:
               if ((data & 3) != 3 && data <= 15) {
                  int store = data & -4;
                  return mod((data & 3) + increment, 3) | store;
               }
            ...
            case 161:
               ...
               int store2 = data & -4;
               return mod((data & 3) + increment, 4) | store2;
            case 23:
            case 158:
               int store3 = data & 8;
               data &= -9;
               ...
               return mod(data + increment, 6) | store3;
            case 29:
            case 33:
            case 43:
            case 44:
            ...
            case 175:
               int store4 = data & 8;
               data &= -9;
               return data > 5 ? -1 : mod(data + increment, 6) | store4;
         }
      }
   }
