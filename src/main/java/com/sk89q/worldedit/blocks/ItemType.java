...
public enum ItemType {
   ...
   @Deprecated
   LOCKED_CHEST(95, "thisblockisinvalidusedstainedglassinstead"),
   ...
   FLOWER_POT_BLOCK(140, "Flower pot", "flowerpot", "plantpot", "pot"),
   ...
   HEAD_BLOCK(144, "Head", "head", "skull"),
   ...
   FLINT_AND_TINDER(
      259, "Flint and tinder", "flintandtinder", "lighter", "flintandsteel", "flintsteel", "flintandiron", "flintnsteel", "flintniron", "flintntinder"
   ),
   ...
   LEATHER_CHEST(
      299, "Leather chestplate", "leatherchest", "leatherchestplate", "leathervest", "leatherbreastplate", "leatherplate", "leathercplate", "leatherbody"
   ),
   ...
   CHAINMAIL_PANTS(
      304, "Chainmail pants", "chainmailpants", "chainmailgreaves", "chainmaillegs", "chainmailleggings", "chainmailstockings", "chainmailbreeches"
   ),
   ...
   DIAMOND_CHEST(
      311, "Diamond chestplate", "diamondchest", "diamondchestplate", "diamondvest", "diamondbreastplate", "diamondplate", "diamondcplate", "diamondbody"
   ),
   ...
   STORAGE_MINECART(342, "Minecart with Chest", "storageminecart", "storagecart", "minecartwithchest", "minecartchest", "chestminecart"),
   POWERED_MINECART(343, "Minecart with Furnace", "poweredminecart", "poweredcart", "minecartwithfurnace", "minecartfurnace", "furnaceminecart"),
   EGG(344, "Egg", "egg"),
   ...
   NETHER_WART_ITEM(372, "Nether wart", "netherwart", "netherwartseed"),
   POTION(373, "Potion", "potion"),
   GLASS_BOTTLE(374, "Glass bottle", "glassbottle"),
   SPIDER_EYE(375, "Spider eye", "spidereye"),
   FERMENTED_SPIDER_EYE(376, "Fermented spider eye", "fermentedspidereye", "fermentedeye"),
   ...
   EYE_OF_ENDER(381, "Eye of Ender", "eyeofender", "endereye"),
   GLISTERING_MELON(382, "Glistering Melon", "glisteringmelon", "goldmelon"),
   SPAWN_EGG(383, "Spawn Egg", "spawnegg", "spawn", "mobspawnegg"),
   BOTTLE_O_ENCHANTING(384, "Bottle o' Enchanting", "expbottle", "bottleoenchanting", "experiencebottle", "exppotion", "experiencepotion"),
   FIRE_CHARGE(385, "Fire Charge", "firecharge", "firestarter", "firerock"),
   BOOK_AND_QUILL(386, "Book and Quill", "bookandquill", "quill", "writingbook"),
   WRITTEN_BOOK(387, "Written Book", "writtenbook"),
   EMERALD(388, "Emerald", "emeraldingot", "emerald"),
   ITEM_FRAME(389, "Item frame", "itemframe", "frame", "itempainting"),
   FLOWER_POT(390, "Flower pot", "flowerpot", "plantpot", "pot"),
   CARROT(391, "Carrot", "carrot"),
   POTATO(392, "Potato", "potato"),
   BAKED_POTATO(393, "Baked potato", "bakedpotato", "potatobaked"),
   POISONOUS_POTATO(394, "Poisonous potato", "poisonpotato", "poisonouspotato"),
   BLANK_MAP(395, "Blank map", "blankmap", "emptymap"),
   GOLDEN_CARROT(396, "Golden carrot", "goldencarrot", "goldcarrot"),
   HEAD(397, "Head", "skull", "head", "headmount", "mount"),
   CARROT_ON_A_STICK(398, "Carrot on a stick", "carrotonastick", "carrotonstick", "stickcarrot", "carrotstick"),
   NETHER_STAR(399, "Nether star", "netherstar", "starnether"),
   PUMPKIN_PIE(400, "Pumpkin pie", "pumpkinpie"),
   FIREWORK_ROCKET(401, "Firework rocket", "firework", "rocket"),
   FIREWORK_STAR(402, "Firework star", "fireworkstar", "fireworkcharge"),
   ENCHANTED_BOOK(403, "Enchanted book", "enchantedbook", "spellbook", "enchantedtome", "tome"),
   COMPARATOR(404, "Comparator", "comparator", "capacitor"),
   NETHER_BRICK_ITEM(405, "Nether Brick (item)", "netherbrickitem"),
   NETHER_QUARTZ(406, "Nether Quartz", "netherquartz", "quartz"),
   TNT_MINECART(407, "Minecart with TNT", "minecraftwithtnt", "tntminecart", "minecarttnt"),
   HOPPER_MINECART(408, "Minecart with Hopper", "minecraftwithhopper", "hopperminecart", "minecarthopper"),
   PRISMARINE_SHARD(409, "Prismarine Shard", "prismarineshard"),
   PRISMARINE_CRYSTALS(410, "Prismarine Crystals", "prismarinecrystals", "prismarinecrystal"),
   RABBIT(411, "Raw Rabbit", "rawrabbit", "rabbit"),
   COOKED_RABBIT(412, "Cooked Rabbit", "cookedrabbit"),
   RABBIT_STEW(413, "Rabbit Stew", "rabbitstew"),
   RABBIT_FOOT(414, "Rabbit's Foot", "rabbitsfoot", "rabbitfoot"),
   RABBIT_HIDE(415, "Rabbit Hide", "rabbithide", "rabbitskin"),
   ARMOR_STAND(416, "Armor Stand", "armorstand"),
   HORSE_ARMOR_IRON(417, "Iron Horse Armor", "ironhorsearmor", "ironbarding"),
   HORSE_ARMOR_GOLD(418, "Gold Horse Armor", "goldhorsearmor", "goldbarding"),
   HORSE_ARMOR_DIAMOND(419, "Diamond Horse Armor", "diamondhorsearmor", "diamondbarding"),
   LEAD(420, "Lead", "lead", "leash"),
   NAME_TAG(421, "Name Tag", "nametag"),
   COMMAND_BLOCK_MINECART(422, "Minecart with Command Block"),
   MUTTON(423, "Mutton", "mutton", "rawmutton"),
   COOKED_MUTTON(424, "Cooked Mutton", "cookedmutton"),
   BANNER(425, "Banner", "banner"),
   END_CRYSTAL(426, "End Crystal", "endcrystal"),
   SPRUCE_DOOR_ITEM(427, "Spruce Door", "sprucedoor"),
   BIRCH_DOOR_ITEM(428, "Birch Door", "birchdoor"),
   JUNGLE_DOOR_ITEM(429, "Jungle Door", "jungledoor"),
   ACACIA_DOOR_ITEM(430, "Acacia Door", "acaciadoor"),
   DARK_OAK_DOOR_ITEM(431, "Dark Oak Door", "darkoakdoor"),
   CHORUS_FRUIT(432, "Chorus Fruit", "chorusfruit"),
   CHORUS_FRUIT_POPPED(433, "Popped Chorus Fruit", "poppedchorusfruit", "chorusfruitpopped", "cookedchorusfruit"),
   BEETROOT(434, "Beetroot", "beetroot"),
   BEETROOT_SEEDS(435, "Beetroot Seeds", "beetrootseeds"),
   BEETROOT_SOUP(436, "Beetroot Soup", "beetrootsoup"),
   DRAGON_BREATH(437, "Dragon Breath", "dragonbreath"),
   SPLASH_POTION(438, "Splash Potion", "splashpotion", "potionsplash"),
   SPECTRAL_ARROW(439, "Spectral Arrow", "spectralarrow", "glowingarrow"),
   TIPPED_ARROW(440, "Tipped Arrow", "tippedarrow", "potionarrow"),
   LINGERING_POTION(441, "Lingering Potion", "lingeringpotion", "potionlingering"),
   SHIELD(442, "Shield", "shield"),
   ELYTRA(443, "Elytra", "elytra", "wings"),
   SPRUCE_BOAT(444, "Spruce Boat", "spruceboat", "boatspruce"),
   BIRCH_BOAT(445, "Birch Boat", "birchboat", "boatbirch"),
   JUNGLE_BOAT(446, "Jungle Boat", "jungleboat", "boatjungle"),
   ACACIA_BOAT(447, "Acacia Boat", "acaciaboat", "boatacacia"),
   DARK_OAK_BOAT(448, "Dark Oak Boat", "darkoakboat", "boatdarkoak"),
   TOTEM_OF_UNDYING(449, "Totem of Undying", "totemofundying", "undyingtotem"),
   SHULKER_SHELL(450, "Shulker Shell", "shulkershell"),
   IRON_NUGGET(452, "Iron Nugget", "ironnugget"),
   KNOWLEDGE_BOOK(453, "Knowledge Book", "knowledgebook", "recipebook"),
   ...
   static {
      ...
      usesDamageValue.add(349);
      usesDamageValue.add(350);
      usesDamageValue.add(425);
   }
}
