...
public class Location {
   ...
   public boolean equals(Object obj) {
      if (!(obj instanceof Location)) {
         ...
         return !this.world.equals(location.world) ? false : this.position.equals(location.position);
      }
   }
   ...
   public String toString() {
      return "World: " + this.world.getName() + ", Coordinates: " + this.position + ", Yaw: " + this.yaw + ", Pitch: " + this.pitch;
   }
