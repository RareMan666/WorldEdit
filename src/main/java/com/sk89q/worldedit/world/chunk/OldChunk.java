...
public class OldChunk implements Chunk {
   ...
   public OldChunk(World world, CompoundTag tag) throws DataException {
      this.rootTag = tag;
      this.blocks = NBTUtils.getChildTag(this.rootTag.getValue(), "Blocks", ByteArrayTag.class).getValue();
      this.data = NBTUtils.getChildTag(this.rootTag.getValue(), "Data", ByteArrayTag.class).getValue();
