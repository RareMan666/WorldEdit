...
import com.sk89q.worldedit.internal.gson.internal.JsonReaderInternalAccess;
...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
   ...
   public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
      ...
      if (!Map.class.isAssignableFrom(rawType)) {
         ...
         TypeAdapter<T> result = (TypeAdapter<T>) new MapTypeAdapterFactory.Adapter(gson, keyAndValueTypes[0], keyAdapter, keyAndValueTypes[1], valueAdapter, constructor);
         return result;
      }
   }
