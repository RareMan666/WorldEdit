...
import com.sk89q.worldedit.internal.gson.internal.$Gson$Preconditions;
...
public final class GsonBuilder {
   ...
   public GsonBuilder registerTypeAdapter(Type type, Object typeAdapter) {
      ...
      if (typeAdapter instanceof TypeAdapter) {
         this.factories.add(TypeAdapters.newFactory((TypeToken)TypeToken.get(type), (TypeAdapter)typeAdapter));
      }
   ...
   public GsonBuilder registerTypeHierarchyAdapter(Class<?> baseType, Object typeAdapter) {
      ...
      if (typeAdapter instanceof TypeAdapter) {
         this.factories.add(TypeAdapters.newTypeHierarchyFactory((Class)baseType, (TypeAdapter)typeAdapter));
      }
