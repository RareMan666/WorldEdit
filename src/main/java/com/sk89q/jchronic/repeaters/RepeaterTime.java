      ...
      if (this._currentTime == null) {
         ...
         if (pointer == Pointer.PointerType.FUTURE) {
            if (tick.isAmbiguous()) {
               ...
               for (Calendar futureDatex : futureDates) {
                  if (futureDatex.after(now) || futureDatex.equals(now)) {
                     this._currentTime = futureDatex;
                     done = true;
                     break;
                  }
               }
            ...
            for (Calendar pastDatex : pastDates) {
               if (pastDatex.before(now) || pastDatex.equals(now)) {
                  this._currentTime = pastDatex;
                  done = true;
                  break;
               }
            }
